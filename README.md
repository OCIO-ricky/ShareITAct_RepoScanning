...
> [!NOTE]
> Unfortunately, **the integration with Azure DevOps repositories was not completed nor tested**.  We diverted efforts to build a leaner solution that doesn't use AI to replace this project altogether for scanning the CDC repositories. See source code @ [ShareIT_Act](https://github.com/CDCgov/ShareIT-Act).
