...
> [!NOTE]
> Unfortunately, **the connector for Azure DevOps repositories was never completed nor tested**.  We diverted efforts at the time to build a leaner solution that doesn't use AI-driven insights to replace this project altogether for scanning CDC repositories. See source code @ [ShareIT_Act](https://github.com/CDCgov/ShareIT-Act).
